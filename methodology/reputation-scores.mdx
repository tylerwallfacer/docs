...
Reputation Scores are also visible in the Vaults.fyi app at [app.vaults.fyi](https://app.vaults.fyi/) and returned in every response from the [detailed vaults endpoint](/api/detailed-vaults).
