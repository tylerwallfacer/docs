...
Vaults.fyi powers yield analytics, dashboards, and transaction flows for [Jumper](https://jumper.exchange/earn), [Kraken Wallet](https://www.kraken.com/wallet), [Gauntlet](https://gauntlet.xyz/), [Maple Finance](https://maple.finance/), and more. See the [case studies](/resources/case-studies) for integration details.
